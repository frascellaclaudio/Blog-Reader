...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let url = URL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyDP4XV7kMGvXLZSXQtbeI21RB_iGZd0LgA")
                    ...
                    do {
                        ...
                        if let items = jsonResult["items"] as? NSArray {
                            ...
                            for item in items as Array {
                                print(item["published"] as! String)
                                print(item["title"] as! String)
                                print(item["content"] as! String)
